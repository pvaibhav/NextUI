...
ifeq ($(PLATFORM), tg5040)
	...
	mkdir -p ./build/EXTRAS/Tools/$(PLATFORM)/Color\ Correction.pak/
	cp ./workspace/$(PLATFORM)/displaycal/build/$(PLATFORM)/displaycal.elf ./build/EXTRAS/Tools/$(PLATFORM)/Color\ Correction.pak/
endif
endif
